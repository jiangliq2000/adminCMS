    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <el-form-item>
            <el-input v-model="filters.name" placeholder="教师姓名" @keyup.enter.native="handleSearch"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-table :data="teachers" highlight-current-row @selection-change="selsChange"
        ...
        <el-table-column prop="options" label="权限" sortable></el-table-column>
      ...
      -->
        ...
        <el-table-column prop="effectivetime" label="生效时间" width="120" sortable></el-table-column>
