  ...
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-table :data="students" highlight-current-row @selection-change="selsChange"
        ...
        <el-table-column prop="urgent_contactor" label="监护人" ></el-table-column>
        <el-table-column prop="urgent_mobile" label="监护人手机" ></el-table-column>
        <!--
      ...
      <el-dialog title="编辑" :visible.sync ="editFormVisible" :close-on-click-modal="false">
        <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
          ...
          <el-form-item label="监护人" prop="urgent_contactor" >
            <el-input v-model="editForm.urgent_contactor" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="监护人手机" prop="urgent_mobile" auto-complete="off" >
          ...
          <el-form-item label="详细信息" prop="detailed" auto-complete="off" :disabled="true">
            <el-input v-model="editForm.detailed" auto-complete="off"></el-input>
          </el-form-item>          
        </el-form>
      ...
      <el-dialog title="新增学生" :visible.sync ="addFormVisible" :close-on-click-modal="false">
        <el-form :model="addForm" label-width="100px" :rules="addFormRules" ref="addForm">
          ...
          <el-form-item label="详细信息" prop="detailed" auto-complete="off" :disabled="true">
            <el-input v-model="addForm.detailed" auto-complete="off"></el-input>
          </el-form-item>            
        </el-form>
        <div slot="footer" class="dialog-footer">
        ...
        API.findList(params).then(function (result) {
          ...
          if (result && result.students) {
            if (result.students.length > 0) {
               ...
               that.students = result.students;
              //replace sex prop
              that.students.forEach((student, index) => {
                if (student.sex == '1'){
                  student.sex = '男'
                }else{
                  student.sex = '女'
